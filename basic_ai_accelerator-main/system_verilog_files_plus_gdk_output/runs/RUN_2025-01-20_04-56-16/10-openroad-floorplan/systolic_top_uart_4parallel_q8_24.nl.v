module systolic_top_uart_4parallel_q8_24 (busy_out,
 ...
 sky130_fd_sc_hd__and2b_2 _07_ (.A_N(start_in),
    .B(\fsm_state[0] ),
    .X(_05_));
 sky130_fd_sc_hd__buf_1 _08_ (.A(_05_),
    .X(_00_));
 sky130_fd_sc_hd__inv_2 _09_ (.A(rst_in),
    .Y(_01_));
 sky130_fd_sc_hd__inv_2 _10_ (.A(rst_in),
    .Y(_02_));
 sky130_fd_sc_hd__inv_2 _11_ (.A(rst_in),
    .Y(_03_));
 sky130_fd_sc_hd__dfstp_2 _12_ (.CLK(clk_in),
    .D(_00_),
    .SET_B(_01_),
    .Q(\fsm_state[0] ));
 sky130_fd_sc_hd__dfrtp_2 _13_ (.CLK(clk_in),
    .D(internal_busy),
    .RESET_B(_02_),
    .Q(busy_out));
 sky130_fd_sc_hd__dfrtp_2 _14_ (.CLK(clk_in),
    .D(_04_),
    .RESET_B(_03_),
    .Q(internal_busy));
 ...
 sky130_fd_sc_hd__buf_2 _19_ (.A(zero_),
    .X(out7));
 sky130_fd_sc_hd__buf_2 _20_ (.A(zero_),
    .X(out8));
 sky130_fd_sc_hd__buf_2 _21_ (.A(zero_),
    .X(rx_out));
